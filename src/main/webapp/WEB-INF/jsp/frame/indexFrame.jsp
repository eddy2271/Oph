...
<frameset rows="170,120,*"  frameborder="no" border="0" framespacing="0">
        ...
        <frame src="${pageContext.request.contextPath}/frame/empty.jsp" style="padding : 2% 2% 2% 2%;" name="mainFrame" id="mainFrame" title="mainFrame"/>
</frameset>
</html>